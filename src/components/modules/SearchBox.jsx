...
const SearchBox = ({
  ...
  return (
    <label
      className={`${styles.searchLabel} rounded-md ${
    ...
    >
      <div className="flex justify-between items-center w-full py-2">
        <div className="flex items-center rounded-md overflow-hidden">
          ...
          <input
            ...
            onBlur={() =>
              windowSize > 760 ? setTimeout(() => setIsShow(false), 200) : ""
            }
            ref={inputRef}
          />
        </div>
        <div className="flex justify-center items-center md:hidden">
          <button
            className="rounded-md bg-[#5463FF] px-3 py-[6px] mt-[5px] text-xs cursor-default"
            onClick={() => {
      ...
      {inputValue === "" &&
        ...
        !isError && (
          <div
            className={`absolute z-[101] left-0 top-[50px] md:top-[36px]  w-full bg-[#171924] text-white rounded-md p-[25px_0px_15px] block max-h-[400px] overflow-y-auto ${
              isShow ? "rounded-t-none" : ""
            }`}
          >
        ...
        : isShow &&
          ...
          searchData && (
            <div
              ...
              } top-[50px] md:top-[36px] rounded-md  ${
                isShow ? "rounded-t-none" : ""
              }`}
            >
